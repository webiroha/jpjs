...
var HeaderFooter_HeaderFooter = function HeaderFooter(inside) {
  ...
  var PageHeader = components_Header();
  WholeFrag().appendChild(PageHeader());
  WholeFrag().appendChild(inside());
  var PageFooter = components_Footer();
...
// EXTERNAL MODULE: ./src/app/components/pages/HeaderFooter/index.js + 2 modules
var HeaderFooter = __webpack_require__(10);
...
// EXTERNAL MODULE: ./src/app/components/Explain/index.js
var Explain = __webpack_require__(7);

// EXTERNAL MODULE: ./src/app/components/CodeBlock/index.js + 1 modules
var CodeBlock = __webpack_require__(6);

// EXTERNAL MODULE: ./src/app/components/NextLink/index.js
var NextLink = __webpack_require__(9);

// CONCATENATED MODULE: ./src/assets/sounds/single/a.wav
/* harmony default export */ var a = (__webpack_require__.p + "assets/sounds/single/a.wav");
// CONCATENATED MODULE: ./src/assets/sounds/single/i.wav
/* harmony default export */ var i = (__webpack_require__.p + "assets/sounds/single/i.wav");
// CONCATENATED MODULE: ./src/assets/sounds/single/u.wav
/* harmony default export */ var u = (__webpack_require__.p + "assets/sounds/single/u.wav");
// CONCATENATED MODULE: ./src/assets/sounds/single/e.wav
/* harmony default export */ var e = (__webpack_require__.p + "assets/sounds/single/e.wav");
// CONCATENATED MODULE: ./src/assets/sounds/single/o.wav
/* harmony default export */ var o = (__webpack_require__.p + "assets/sounds/single/o.wav");
...
var vowels_Vowels = function Vowels() {
  var ContentsFrag = Object(Frag["a" /* default */])();
  var ExplainInfo = {
    title: 'Vowels',
    text: 'Japanese has 5 vowels.'
  };
  var VowelsExplain = Object(Explain["a" /* default */])(ExplainInfo);
  ContentsFrag().appendChild(VowelsExplain());
  var vowelsByRomaji = "const vowelsByRomaji = ['a', 'i', 'u', 'e', 'o'];";

  var _CodeBlock = Object(CodeBlock["a" /* default */])(vowelsByRomaji),
      VowelsCode = _CodeBlock.Code;

  ContentsFrag().appendChild(VowelsCode.tag);
  var NoteText = Object(Element["a" /* default */])({
    elem: 'p',
    "class": 'text opacity_0 slide-in-upper__1',
  ...
  ContentsFrag().appendChild(Object(NextLink["a" /* default */])(''));
  return ContentsFrag();
};

Object(HeaderFooter["a" /* default */])(vowels_Vowels); // const vowelsLetters = [
